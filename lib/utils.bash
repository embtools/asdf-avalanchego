...
# NOTE: You might want to remove this if avalanche-cli is not hosted on GitHub releases.
...
list_all_versions() {
	...
	# Change this function if avalanche-cli has other means of determining installable versions.
	list_github_tags
}
...
install_version() {
	...
	(
		...
		# TODO: Assert avalanche-cli executable exists.
		local tool_cmd
